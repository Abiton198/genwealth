const translationsXh ={
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    //GUIDE
welcome: "Wamkelekile ekulungwini olungaphambili lwezemfundo!",
signup: "Indlela yokubhalisa iyanokusimple ngenxa yokuthi iyathandwa ukuze yakuqoqa ebusweni bakho kwi-nxibelelwano usebenzisa iifowuni noma iilaptophi kwelinye icala kwakho. Ekuqaleni kweli slayidi, sizokuthuthela kwiindwendwe ezilula ezintandathu kunye nentlalo oyifunayo ukuqoqa!",
step1: "Inzululwazi yokubhalisa",
goon: "Hamba ekuseni kuwamaDuePoint uqalise indlela:",
step2: "Inzululwazi yokufaka kwamaqela",
asyou2: "Njengoko uthetha apho esiqalekileyo kwi-imijelo, i-home page yeDuePoint ithiwe kwiwe ukuqala noma ukubhalisa. Ndiyavuya ukuba ulondolozele.",
congrats: "Isigqibo sakho sokuthengiswa kwezithuthi malungu lwabaphambili linjenge-lokusa! Usebenza namanye amathuba we-Finance. Ndiyavuya ukuba ulondolozele!",
step3: "Inzululwazi yokufaka ukubhalisa",
thismust: "Le mihla kungenakuba phakathi kakhulu kwakhona kwam, kithi nabo! Siphumelelele sizibalisela njengobomi bakho bethu, uthini na. Ndiza kuncoma ngokuqhutywa kwakho! Sicela ufumanele:",
nexttime: "Kwelo xesha ke liyabonakala intando zibonakala kuwe. Ndiyabulela! Jikelele uze unakhele!",
step4: "Ukufakela amafomu",
nowits: "Ngoku ke isikhathi sokufakela izinto zakho. Yenza kahle, isistimu ifaka imibhalo yakuFICA, kufuneka uyikhombise nje!",
idnu: "I-South African ID okanye iipasipoti ezintsha ezenziwe ngaphandle",
proofofres: "Isikhokelo - ikhukhi le-utility noma isitatimende noma into enokwenza kuyo",
next: "Ngokwesibini, nceda uvulele isikhokelo sakho singenelela kukhuphiswano.",
update: "ukuba uzicelo izicelo, ukuze ubhalisele ingcaciso.",
setdebit: "Setha usuku lokubalisela kwi-akhawunti yakho (akukho okanye okanye umonakalo ekhaya ukuze uzibaliselise ingcaciso!)",
belowimages: "Ii-imijelo zasesidlangaleni zikwenza ukuba usixhase izinto, khetha okwethu.",
step5: "Vunyanisa isicelo kwi-PlayStore",
thenlastly: "Kwelo nyanga ozayo uza kuziva kahle! Yebo, uhambise isicelo. Faka ezantsi, ehlabathini lakho",
verylight: "Isicelo esincinci kodwa esinthandwayo sisemva kulezilwandle. 'Ibhande lentshona yakho': DUEPOINT. Buka umjelo oluphambene ophambi kwaba lokho ujoyina.",
