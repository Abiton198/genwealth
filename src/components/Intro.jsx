    ...
    <div className="bg-white rounded-lg p-4 relative">
      ...
      <div className="w-full md:flex justify-between items-center">
        ...
        <div className="mt-4 md:mt-0 md:ml-4 w-full md:w-1/2 flex items-center">
            ...
            />
            <div>
              <p className="text-black xl font-bold">3 mins Intro!</p>
      ...
      <div className="w-full md:flex justify-between items-center mt-4">
        ...
        <div className="mt-4 md:mt-0 md:ml-4 w-full md:w-1/2 flex items-center">
            ...
            />
            <div>
              <p className="text-black xl font-bold">10 mins Intro!</p>
    ...
    <a href='/Signup'>
      ...
      <div className="mt-4 md:mt-0 md:ml-4 w-full md:w-1/2 flex items-center">
       ...
       <a href={`whatsapp://send?phone=${whatsappNumber}`} target="_blank" rel="noopener noreferrer">
        <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded inline-flex items-center animate-flicker mt-5">
