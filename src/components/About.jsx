      ...
      <div className={isCollapsed ? 'block' : 'hidden'}>
        <p className="text-black mb-4">
          ...
          In light of the challenging economic landscape in South Africa and across the globe, we have sought out alternative avenues to supplement our income. 
            ...
            <p className='text-black mt-4'>We understand the importance of finding stable and dependable sources of revenue, which can often be elusive.
        ...
        <p className='text-black mt-4'>  Our role as Wealth Engineers with Duepoint is simple - to share this remarkable opportunity with individuals we encounter in our everyday lives.
...
<p className='text-black mt-4'>As you can see, it requires minimal effort to introduce you to this platform, and with the same level of effort, you too can become a part of this venture and share it with others.
